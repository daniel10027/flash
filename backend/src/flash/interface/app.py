...
from flash.interface.http import admin_tariffs as admin_tariffs_routes
from flash.interface.http import audit as audit_routes
...
from flash.interface.http import compliance as compliance_routes
from flash.interface.http import kyc as kyc_routes
from flash.interface.http import merchant_public as merchant_public_routes
...
def create_app(
    ...
    *,
    ...
    app.register_blueprint(merchant_public_routes.bp)
    ...
    app.register_blueprint(admin_tariffs_routes.bp)
